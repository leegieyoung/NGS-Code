...
AGE <- read.table("/ichrogene/project/temp/gylee/0.GWAS/Ukb/subset_of_ukb45411_for_age.txt", header=T, comment.char = "")
SEX <- read.table("/ichrogene/project/temp/gylee/0.GWAS/Ukb/subset_of_ukb45411_for_sex.txt", header=T, comment.char = "")
head(SEX)
