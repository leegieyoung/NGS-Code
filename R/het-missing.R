...
Bhm <- read.table(paste0(RESULT_DIR,"R_BeforeQC_check.txt"), header=T, comment.char = "")

Bhm$HET_RATE = (Bhm$OBS_CT - Bhm$O.HOM.)/Bhm$OBS_CT


png(filename=paste0(RESULT_DIR,"R_BeforeQC_check.png"), width=20, height=16, units="cm", res=200)
