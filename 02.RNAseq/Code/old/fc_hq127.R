...
fc127 <- read.csv("/data/keeyoung/gy_RNA/02.featureCounts/127_Scomma.csv", sep=',', head=T)
fc127 <- fc127[,-1]
fc127 <- t(fc127)

#pheno : dot -> hyphen
fc127.names <- scan("/data/keeyoung/gy_RNA/02.featureCounts/127.IBD.hyphen.list", what=character(0))
...
write.csv(CDvsUC_in_result, "/data/keeyoung/gy_RNA/04.CSV/fc127_CDvsUC_in_ensembl.csv", row.names=TRUE)
write.csv(CDvsUC_no_result, "/data/keeyoung/gy_RNA/04.CSV/fc127_CDvsUC_no_ensembl.csv", row.names=TRUE)
write.csv(INvsNO_CD_result, "/data/keeyoung/gy_RNA/04.CSV/fc127_INvsNO_CD_ensembl.csv", row.names=TRUE)
write.csv(INvsNO_UC_result, "/data/keeyoung/gy_RNA/04.CSV/fc127_INvsNO_UC_ensembl.csv", row.names=TRUE)
...
write.csv(CDvsUC_in_result, "/data/keeyoung/gy_RNA/04.CSV/fc127_CDvsUC_in_ENTREZID.csv", row.names=TRUE)
write.csv(CDvsUC_no_result, "/data/keeyoung/gy_RNA/04.CSV/fc127_CDvsUC_no_ENTREZID.csv", row.names=TRUE)
write.csv(INvsNO_CD_result, "/data/keeyoung/gy_RNA/04.CSV/fc127_INvsNO_CD_ENTREZID.csv", row.names=TRUE)
write.csv(INvsNO_UC_result, "/data/keeyoung/gy_RNA/04.CSV/fc127_INvsNO_UC_ENTREZID.csv", row.names=TRUE)
