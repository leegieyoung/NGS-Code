...
png(filename="/data/keeyoung/gy_RNA/03.Plot/hg19_234_PCA.png")
...
write.csv(CDvsUC_in_result, "/data/keeyoung/gy_RNA/04.CSV/hg19_234_CDvsUC_in.csv", row.names=TRUE)
write.csv(CDvsUC_no_result, "/data/keeyoung/gy_RNA/04.CSV/hg19_234_CDvsUC_no.csv", row.names=TRUE)
write.csv(INvsNO_CD_result, "/data/keeyoung/gy_RNA/04.CSV/hg19_234_INvsNO_CD.csv", row.names=TRUE)
write.csv(INvsNO_UC_result, "/data/keeyoung/gy_RNA/04.CSV/hg19_234_INvsNO_UC.csv", row.names=TRUE)
