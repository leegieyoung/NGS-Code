...
fc299 <- read.csv("/data/keeyoung/gy_RNA/02.featureCounts/gene_id/trans_299.IBD.fc_P_M.merge", sep='\t', head=T)
fc299 <- fc299[,-1]
fc299 <- t(fc299)
...
png(filename="/data/keeyoung/gy_RNA/03.Plot/fc299.PCA.png")
...
write.table(CDvsUC_in_result, "/data/keeyoung/gy_RNA/04.CSV/fc299_CDvsUC_in_P_M_ensembl.csv", row.names=TRUE, quote=F, sep=",")
write.table(CDvsUC_no_result, "/data/keeyoung/gy_RNA/04.CSV/fc299_CDvsUC_no_P_M_ensembl.csv", row.names=TRUE, quote=F, sep=",")
write.table(INvsNO_CD_result, "/data/keeyoung/gy_RNA/04.CSV/fc299_INvsNO_CD_P_M_ensembl.csv", row.names=TRUE, quote=F, sep=",")
write.table(INvsNO_UC_result, "/data/keeyoung/gy_RNA/04.CSV/fc299_INvsNO_UC_P_M_ensembl.csv", row.names=TRUE, quote=F, sep=",")
...
write.table(CDvsUC_in_result, "/data/keeyoung/gy_RNA/04.CSV/fc299_CDvsUC_in_P_M_ENTREZID.csv", row.names=TRUE, quote=F, sep=",")
write.table(CDvsUC_no_result, "/data/keeyoung/gy_RNA/04.CSV/fc299_CDvsUC_no_P_M_ENTREZID.csv", row.names=TRUE, quote=F, sep=",")
write.table(INvsNO_CD_result, "/data/keeyoung/gy_RNA/04.CSV/fc299_INvsNO_CD_P_M_ENTREZID.csv", row.names=TRUE, quote=F, sep=",")
write.table(INvsNO_UC_result, "/data/keeyoung/gy_RNA/04.CSV/fc299_INvsNO_UC_P_M_ENTREZID.csv", row.names=TRUE, quote=F, sep=",")
