...
fc127 <- read.csv("/data/keeyoung/gy_RNA/02.featureCounts/gene_name/127_Scomma.csv", sep=',', head=T)
fc127 <- fc127[,-1]
fc127 <- t(fc127)
...
write.table(CDvsUC_in_result, "/data/keeyoung/gy_RNA/04.CSV/fc127_S_CDvsUC_in_ensembl.csv", row.names=TRUE, quote=F, sep=",")
write.table(CDvsUC_no_result, "/data/keeyoung/gy_RNA/04.CSV/fc127_S_CDvsUC_no_ensembl.csv", row.names=TRUE, quote=F, sep=",")
write.table(INvsNO_CD_result, "/data/keeyoung/gy_RNA/04.CSV/fc127_S_INvsNO_CD_ensembl.csv", row.names=TRUE, quote=F, sep=",")
write.table(INvsNO_UC_result, "/data/keeyoung/gy_RNA/04.CSV/fc127_S_INvsNO_UC_ensembl.csv", row.names=TRUE, quote=F, sep=",")
...
write.table(CDvsUC_in_result, "/data/keeyoung/gy_RNA/04.CSV/fc127_S_CDvsUC_in_ENTREZID.csv", row.names=TRUE, quote=F, sep=",")
write.table(CDvsUC_no_result, "/data/keeyoung/gy_RNA/04.CSV/fc127_S_CDvsUC_no_ENTREZID.csv", row.names=TRUE, quote=F, sep=",")
write.table(INvsNO_CD_result, "/data/keeyoung/gy_RNA/04.CSV/fc127_S_INvsNO_CD_ENTREZID.csv", row.names=TRUE, quote=F, sep=",")
write.table(INvsNO_UC_result, "/data/keeyoung/gy_RNA/04.CSV/fc127_S_INvsNO_UC_ENTREZID.csv", row.names=TRUE, quote=F, sep=",")
