...
#RNAseq("CD_in_Total",iCD)
#source(paste0("/data/keeyoung/gy_RNA/Code/source/","source_RNAseq_normalized_ensemblToGenesymbol_CD_in_Total_rmCD_INvsNO.R")) ##221006 GO func
#RNAseq("CD_in_Total",iCD)
#source(paste0("/data/keeyoung/gy_RNA/Code/source/","source_RNAseq_normalized_ensemblToGenesymbol_CD_in_Total_rmCD_INvsNO_After_221011.R")) #2210111 After norm, Common genes
#RNAseq("CD_in_Total_After",iCD)
...
#RNAseq("CD_in_Total_792genes",iCD)
