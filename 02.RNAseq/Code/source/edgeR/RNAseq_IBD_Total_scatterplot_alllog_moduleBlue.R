...
Genes <- data.frame(t(y_uniq.lcpm[which(rownames(y_uniq.lcpm) %in% c("GAS1","LRRC15","MMP13","EGFL6","FAP")),]))
#
...
#FAP_others
#FAP_GAS1
png(filename=paste0(work_dir,"01.Plot/All_log_FAP_GAS1.png"), width=60, height=50, units="cm", res=200)
ggplot(data=Genes, mapping=aes(x=FAP,y=GAS1, shape=response, color=response)) +
    geom_point(size=5) +
    geom_smooth(method=lm, se=FALSE) +
    xlab(expression("log"[2]*"FAP")) +
    ylab(expression("log"[2]*"GAS1")) +
    scale_x_continuous(limits = c(min(Genes$FAP)-1, max(Genes$FAP)+1))+
    scale_y_continuous(limits = c(min(Genes$GAS1)-1, max(Genes$GAS1)+1)) +
...
#FAP_LRRC15
png(filename=paste0(work_dir,"01.Plot/All_log_FAP_LRRC15.png"), width=60, height=50, units="cm", res=200)
ggplot(data=Genes, mapping=aes(x=FAP,y=LRRC15, shape=response, color=response)) +
    geom_point(size=5) +
    geom_smooth(method=lm, se=FALSE) +
    xlab(expression("log"[2]*"FAP")) +
    ylab(expression("log"[2]*"LRRC15")) +
    scale_x_continuous(limits = c(min(Genes$FAP)-1, max(Genes$FAP)+1))+
    scale_y_continuous(limits = c(min(Genes$LRRC15)-1, max(Genes$LRRC15)+1)) +
    theme(axis.title=element_text(size=25), axis.text=element_text(size=20), legend.title=element_text(size=25), legend.text=element_text(size=20)) +
    guides(colour= guide_legend(override.aex=list(size=1.5)))
dev.off()

#FAP_MMP13
png(filename=paste0(work_dir,"01.Plot/All_log_FAP_MMP13.png"), width=60, height=50, units="cm", res=200)
ggplot(data=Genes, mapping=aes(x=FAP,y=MMP13, shape=response, color=response)) +
    geom_point(size=5) +
    geom_smooth(method=lm, se=FALSE) +
    xlab(expression("log"[2]*"FAP")) +
    ylab(expression("log"[2]*"MMP13")) +
    scale_x_continuous(limits = c(min(Genes$FAP)-1, max(Genes$FAP)+1))+
    scale_y_continuous(limits = c(min(Genes$MMP13)-1, max(Genes$MMP13)+1)) +
    theme(axis.title=element_text(size=25), axis.text=element_text(size=20), legend.title=element_text(size=25), legend.text=element_text(size=20)) +
    guides(colour= guide_legend(override.aex=list(size=1.5)))
dev.off()

#FAP_EGFL6
png(filename=paste0(work_dir,"01.Plot/All_log_FAP_EGFL6.png"), width=60, height=50, units="cm", res=200)
ggplot(data=Genes, mapping=aes(x=FAP,y=EGFL6, shape=response, color=response)) +
    geom_point(size=5) +
    geom_smooth(method=lm, se=FALSE) +
    xlab(expression("log"[2]*"FAP")) +
    ylab(expression("log"[2]*"EGFL6")) +
    scale_x_continuous(limits = c(min(Genes$FAP)-1, max(Genes$FAP)+1))+
    scale_y_continuous(limits = c(min(Genes$EGFL6)-1, max(Genes$EGFL6)+1)) +
    theme(axis.title=element_text(size=25), axis.text=element_text(size=20), legend.title=element_text(size=25), legend.text=element_text(size=20)) +
    guides(colour= guide_legend(override.aex=list(size=1.5)))
dev.off()
...
#FAP_others
#FAP_GAS1
png(filename=paste0(work_dir,"01.Plot/All_log_OnlyRNR_FAP_GAS1.png"), width=60, height=50, units="cm", res=200)
ggplot(data=OnlyRNR_Genes, mapping=aes(x=FAP,y=GAS1, shape=RNR, color=RNR)) +
    geom_point(size=5) +
    geom_smooth(method=lm, se=FALSE) +
    xlab(expression("log"[2]*"FAP")) +
    ylab(expression("log"[2]*"GAS1")) +
...
#FAP_LRRC15
png(filename=paste0(work_dir,"01.Plot/All_log_OnlyRNR_FAP_LRRC15.png"), width=60, height=50, units="cm", res=200)
ggplot(data=OnlyRNR_Genes, mapping=aes(x=FAP,y=LRRC15, shape=RNR, color=RNR)) +
    geom_point(size=5) +
    geom_smooth(method=lm, se=FALSE) +
    xlab(expression("log"[2]*"FAP")) +
    ylab(expression("log"[2]*"LRRC15")) +
...
#FAP_MMP13
png(filename=paste0(work_dir,"01.Plot/All_log_OnlyRNR_FAP_MMP13.png"), width=60, height=50, units="cm", res=200)
ggplot(data=OnlyRNR_Genes, mapping=aes(x=FAP,y=MMP13, shape=RNR, color=RNR)) +
    geom_point(size=5) +
    geom_smooth(method=lm, se=FALSE) +
    xlab(expression("log"[2]*"FAP")) +
    ylab(expression("log"[2]*"MMP13")) +
...
#FAP_EGFL6
png(filename=paste0(work_dir,"01.Plot/All_log_OnlyRNR_FAP_EGFL6.png"), width=60, height=50, units="cm", res=200)
ggplot(data=OnlyRNR_Genes, mapping=aes(x=FAP,y=EGFL6, shape=RNR, color=RNR)) +
    geom_point(size=5) +
    geom_smooth(method=lm, se=FALSE) +
    xlab(expression("log"[2]*"FAP")) +
    ylab(expression("log"[2]*"EGFL6")) +
