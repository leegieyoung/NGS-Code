...
############WGCNA#####################
#00.input data
datExpr <- t(cpm(y_uniq[which(rownames(y_uniq) %in% rownames(qcFtest)),], log=F))
...
#26    26 0.80108524 -1.6284183      0.9869628   17.336573   10.3409270
...
genes[which(genes %in% c("FAP","THBS2","TNF","STAT4","IL6"))]
