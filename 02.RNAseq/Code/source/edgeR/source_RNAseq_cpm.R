...
write.table(cnt.cpm, paste0(work_dir,"02.Table","/",name,"_cpm.txt"), sep='\t', quote=F,col.names=T, row.names=T)
write.table(cnt.cpm, paste0(work_dir,"02.Table","/",name,"_lcpm.txt"), sep='\t', quote=F,col.names=T, row.names=T)
