...
#Plot
#THBS2_IL6
png(filename=paste0(work_dir,"01.Plot/THBS2_IL6.png"), width=60, height=50, units="cm", res=200)
ggplot(data=Genes, mapping=aes(x=THBS2,y=IL6, shape=response, color=response)) + 
    geom_point(size=5) + 
    ...
    scale_y_continuous(limits = c(min(Genes$IL6)-1, max(Genes$IL6)+1)) +
...
ggplot(data=Genes, mapping=aes(x=THBS2,y=FAP, shape=response, color=response)) + 
	geom_point(size=5) + 
	geom_smooth(method=lm, se=FALSE) + 
	xlab(expression("log"[2]*"THBS2")) +
	ylab(expression("log"[2]*"FAP")) +
    scale_x_continuous(limits = c(min(Genes$THBS2)-1, max(Genes$THBS2)+1))+
    scale_y_continuous(limits = c(min(Genes$FAP)-1, max(Genes$FAP)+1)) +
	theme(axis.title=element_text(size=25), axis.text=element_text(size=20), legend.title=element_text(size=25), legend.text=element_text(size=20)) +
	guides(colour= guide_legend(override.aex=list(size=1.5)))
dev.off()

#THBS2_STAT4
png(filename=paste0(work_dir,"01.Plot/THBS2_STAT4.png"), width=60, height=50, units="cm", res=200)
ggplot(data=Genes, mapping=aes(x=THBS2,y=STAT4, shape=response, color=response)) + 
    geom_point(size=5) + 
    geom_smooth(method=lm, se=FALSE) + 
    xlab(expression("log"[2]*"THBS2")) +
    ylab(expression("log"[2]*"STAT4")) +
    scale_x_continuous(limits = c(min(Genes$THBS2)-1, max(Genes$THBS2)+1))+
    scale_y_continuous(limits = c(min(Genes$STAT4)-1, max(Genes$STAT4)+1)) +
    theme(axis.title=element_text(size=25), axis.text=element_text(size=20), legend.title=element_text(size=25), legend.text=element_text(size=20)) +
    guides(colour= guide_legend(override.aex=list(size=1.5)))
dev.off()

#THBS2_TNF
png(filename=paste0(work_dir,"01.Plot/THBS2_TNF.png"), width=60, height=50, units="cm", res=200)
ggplot(data=Genes, mapping=aes(x=THBS2,y=TNF, shape=response, color=response)) + 
    geom_point(size=5) + 
    geom_smooth(method=lm, se=FALSE) + 
    xlab(expression("log"[2]*"THBS2")) +
    ylab(expression("log"[2]*"TNF")) +
    scale_x_continuous(limits = c(min(Genes$THBS2)-1, max(Genes$THBS2)+1))+
    scale_y_continuous(limits = c(min(Genes$TNF)-1, max(Genes$TNF)+1)) +
    theme(axis.title=element_text(size=25), axis.text=element_text(size=20), legend.title=element_text(size=25), legend.text=element_text(size=20)) +
    guides(colour= guide_legend(override.aex=list(size=1.5)))
dev.off()

#THBS2_Activated_fibroblast
png(filename=paste0(work_dir,"01.Plot/THBS2_Ac.fb.png"), width=60, height=50, units="cm", res=200)
...
ggplot(data=Genes, mapping=aes(x=FAP,y=IL6, shape=response, color=response)) +
    geom_point(size=5) +
    geom_smooth(method=lm, se=FALSE) +
...
#FAP_STAT4
png(filename=paste0(work_dir,"01.Plot/FAP_STAT4.png"), width=60, height=50, units="cm", res=200)
ggplot(data=Genes, mapping=aes(x=FAP,y=STAT4, shape=response, color=response)) +
    geom_point(size=5) +
    geom_smooth(method=lm, se=FALSE) +
    xlab(expression("log"[2]*"FAP")) +
    ylab(expression("log"[2]*"STAT4")) +
...
#FAP_TNF
png(filename=paste0(work_dir,"01.Plot/FAP_TNF.png"), width=60, height=50, units="cm", res=200)
ggplot(data=Genes, mapping=aes(x=FAP,y=TNF, shape=response, color=response)) +
    geom_point(size=5) +
    geom_smooth(method=lm, se=FALSE) +
    xlab(expression("log"[2]*"FAP")) +
    ylab(expression("log"[2]*"TNF")) +
...
png(filename=paste0(work_dir,"01.Plot/FAP_Ac.fb.png"), width=60, height=50, units="cm", res=200)
...
#STAT4_TNF
png(filename=paste0(work_dir,"01.Plot/STAT4_TNF.png"), width=60, height=50, units="cm", res=200)
ggplot(data=Genes, mapping=aes(x=STAT4,y=TNF, shape=response, color=response)) +
    geom_point(size=5) +
    geom_smooth(method=lm, se=FALSE) +
    xlab(expression("log"[2]*"STAT4")) +
    ylab(expression("log"[2]*"TNF")) +
    scale_x_continuous(limits = c(min(Genes$STAT4)-1, max(Genes$STAT4)+1))+
    scale_y_continuous(limits = c(min(Genes$TNF)-1, max(Genes$TNF)+1)) +
    theme(axis.title=element_text(size=25), axis.text=element_text(size=20), legend.title=element_text(size=25), legend.text=element_text(size=20)) +
    guides(colour= guide_legend(override.aex=list(size=1.5)))
dev.off()
...
#OnlyRNR
#THBS2_IL6
png(filename=paste0(work_dir,"01.Plot/RNR_THBS2_IL6.png"), width=60, height=50, units="cm", res=200)
ggplot(data=OnlyRNR_Genes, mapping=aes(x=THBS2,y=IL6, shape=response, color=response)) +
    geom_point(size=5) +
    geom_smooth(method=lm, se=FALSE) +
    xlab(expression("log"[2]*"THBS2")) +
    ylab(expression("log"[2]*"IL6")) +
    scale_x_continuous(limits = c(min(OnlyRNR_Genes$THBS2)-1, max(OnlyRNR_Genes$THBS2)+1))+
    scale_y_continuous(limits = c(min(OnlyRNR_Genes$IL6)-1, max(OnlyRNR_Genes$IL6)+1)) +
    theme(axis.title=element_text(size=25), axis.text=element_text(size=20), legend.title=element_text(size=25), legend.text=element_text(size=20)) +
    guides(colour= guide_legend(override.aex=list(size=1.5)))
dev.off()

#FAP_Activated_fibroblast
png(filename=paste0(work_dir,"01.Plot/OnlyRNR_FAP_Ac.fb.png"), width=60, height=50, units="cm", res=200)
...
#THBS2_Activated_fibroblast
png(filename=paste0(work_dir,"01.Plot/OnlyRNR_THBS2_Ac.fb.png"), width=60, height=50, units="cm", res=200)
