...
#source(paste0("/data/keeyoung/gy_RNA/Code/source/","source_RNAseq_sPLSDA_perf_Total.R"))
source(paste0("/data/keeyoung/gy_RNA/Code/source/","source_RNAseq_sPLSDA_perf_Total_comp1_vari100.R"))
QC_sPLSDA("CD_no_other",iCD)
