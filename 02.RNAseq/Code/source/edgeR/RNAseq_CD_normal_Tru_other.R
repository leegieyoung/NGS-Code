...
#source(paste0("/data/keeyoung/gy_RNA/Code/source/","source_RNAseq_sPLSDA_perf.R"))
source(paste0("/data/keeyoung/gy_RNA/Code/source/","source_RNAseq_sPLSDA_perf_Tru_comp1_vari90.R"))
QC_sPLSDA("CD_no_Tru_other",iCD)
