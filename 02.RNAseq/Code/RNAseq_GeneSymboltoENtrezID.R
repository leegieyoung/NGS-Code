...
write.table(keg.up.down, paste0(work_dir,"03.Pathway/","kegg.up.down.txt"), quote=F, col.names=T, row.names=F, sep="\t")
...
write.table(go.up.down, paste0(work_dir,"03.Pathway/","go.up.down.txt"), quote=F, col.names=T, row.names=F, sep="\t")
...
write.table(go.up.bp, paste0(work_dir,"03.Pathway/","go.up.bp.txt"),quote=F, col.names=T, row.names=F, sep="\t")
go.up.cc <- go.up[which(go.up[,1] %in% cc[,1]),]
write.table(go.up.cc,  paste0(work_dir,"03.Pathway/","go.up.cc.txt"),quote=F, col.names=T, row.names=F, sep="\t")
go.up.mf <- go.up[which(go.up[,1] %in% mf[,1]),]
write.table(go.up.mf, paste0(work_dir,"03.Pathway/","go.up.mf.txt"),quote=F, col.names=T, row.names=F, sep="\t")

go.down.bp <- go.down[which(go.down[,1] %in% bp[,1]),]
write.table(go.down.bp, paste0(work_dir,"03.Pathway/","go.down.bp.txt"),quote=F, col.names=T, row.names=F, sep="\t")
go.down.cc <- go.down[which(go.down[,1] %in% cc[,1]),]
write.table(go.down.cc, paste0(work_dir,"03.Pathway/","go.down.cc.txt"),quote=F, col.names=T, row.names=F, sep="\t")
go.down.mf <- go.down[which(go.down[,1] %in% mf[,1]),]
write.table(go.down.mf, paste0(work_dir,"03.Pathway/","go.down.mf.txt"),quote=F, col.names=T, row.names=F, sep="\t")
