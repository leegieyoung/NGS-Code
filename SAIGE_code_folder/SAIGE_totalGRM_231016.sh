...
Rscript ${SAGE_CD}/step1_fitNULLGLMM.R     \
       --sparseGRMFile=${Dir}/2.SAIGE_result/${Sample}/sparseGRM/sparseGRM_relatednessCutoff_0.125_2000_randomMarkersUsed.sparseGRM.mtx \
        --sparseGRMSampleIDFile=${Dir}/2.SAIGE_result/${Sample}/sparseGRM/sparseGRM_relatednessCutoff_0.125_2000_randomMarkersUsed.sparseGRM.mtx.sampleIDs.txt \
        --plinkFile=${Dir}/2.SAIGE_result/${Sample}/sparseGRM/LD_pruned_QC/chr${Chr}.LD_pruned_QC_${Sample}  \
	...
	--useSparseGRMforVarRatio=TRUE \
        ...
        --IsOverwriteVarianceRatioFile=TRUE > ${Log}/chr${Chr}.${Sample}.LDpruned.total.log 2>&1
...
Rscript ${SAGE_CD}/step2_SPAtests.R \
	...
	--is_imputed_data=TRUE \
        ...
        --is_fastTest=TRUE \
        --is_output_moreDetails=TRUE > ${Log}/chr${Chr}.${Sample}.LDpruned.total.SAIGE.test.markers.log 3>&1
