...
bash /ichrogene/project/temp/gylee/0.GWAS/Code/SAIGE_code_folder/total/SAIGE_totalGRM_CreateGRM_5000_231121.sh ${Sample} ${Thread}
...
for A in $(seq 1 22)
do
nohup bash /ichrogene/project/temp/gylee/0.GWAS/Code/SAIGE_code_folder/total/SAIGE_totalGRM_5000_231121.sh ${Sample} ${Thread} ${A} > ${Log}.chr${A}.doSAIGE.txt 2>&1 &
done
wait
bash /ichrogene/project/temp/gylee/0.GWAS/Code/SAIGE_code_folder/total/Step3.merge.sh ${Sample} ${Thread}
