...
for A in $(seq 1 22)
do
 nohup bash /ichrogene/project/temp/gylee/0.GWAS/Code/SAIGE_code_folder/total/SAIGE_totalGRM_5000_240403.TrainVali.sh ${Sample} ${Thread} ${A} ${TrainVali} > ${Log}/do_SAIGE.chr${A}.total5000.txt 2>&1 &
 sleep 2
done
wait
