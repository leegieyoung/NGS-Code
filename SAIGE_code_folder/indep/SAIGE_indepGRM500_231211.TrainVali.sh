...
Rscript ${SAGE_CD}/step1_fitNULLGLMM.R     \
       --sparseGRMFile=${SAIGE_dir}/sparseGRM/chr${Chr}.sparseGRM_relatednessCutoff_0.125_500_randomMarkersUsed.sparseGRM.mtx \
        --sparseGRMSampleIDFile=${SAIGE_dir}/sparseGRM/chr${Chr}.sparseGRM_relatednessCutoff_0.125_500_randomMarkersUsed.sparseGRM.mtx.sampleIDs.txt \
        --plinkFile=${SAIGE_dir}/sparseGRM/LD_pruned_QC/chr${Chr}.LD_pruned_QC_${Sample}  \
