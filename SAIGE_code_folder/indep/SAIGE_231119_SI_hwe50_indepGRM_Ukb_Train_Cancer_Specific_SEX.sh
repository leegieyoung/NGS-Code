...
bash /ichrogene/project/temp/gylee/0.GWAS/Code/SAIGE_code_folder/indep/SAIGE_indepGRM_CreateGRM_231017.sh ${Sample} ${Thread}
...
for A in $(seq 1 20)
do
 nohup bash /ichrogene/project/temp/gylee/0.GWAS/Code/SAIGE_code_folder/indep/SAIGE_indepGRM2000_231017_Specific_SEX.sh ${Sample} ${Thread} ${A} > ${Log}/do_SAIGE.chr${A}.indep2000.txt 2>&1 &
 sleep 2
done
wait
...
for A in $(seq 21 22)
do
 nohup bash /ichrogene/project/temp/gylee/0.GWAS/Code/SAIGE_code_folder/indep/SAIGE_indepGRM1000_231017_Specific_SEX.sh ${Sample} ${Thread} ${A} > ${Log}/do_SAIGE.chr${A}.indep1000.txt 2>&1 &
 sleep 2
done
wait
