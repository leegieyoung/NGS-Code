...
bash /ichrogene/project/temp/gylee/0.GWAS/Code/SAIGE_code_folder/indep/SAIGE_indepGRM_CreateGRM_240315.Sparse500.TrainVali.sh ${Sample} ${Thread} ${TrainVali}
...
do
if [ $A -gt 20 ]; then
 nohup bash /ichrogene/project/temp/gylee/0.GWAS/Code/SAIGE_code_folder/indep/SAIGE_indepGRM500_231211_Specific_SEX.TrainVali.sh ${Sample} ${Thread} ${A} ${TrainVali} > ${Log}/do_SAIGE.chr${A}.indep500.txt 2>&1 &
 sleep 2
else
