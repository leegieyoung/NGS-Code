...
cp -n ${Dir}/2.SAIGE_result/${Sample}/sparseGRM/sparseGRM_relatednessCutoff_0.125_5000_randomMarkersUsed.sparseGRM.mtx* ${Dir}/2.SAIGE_result/${Sample}/sparseGRM/GRM
