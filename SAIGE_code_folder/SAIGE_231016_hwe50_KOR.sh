...
for A in $(seq 1 22)
do
nohup singularity exec --bind /mnt/:/mnt/ /mnt/nas/gylee/Singurality/SAIGE/SAIGE_docker_R36.sif bash /mnt/nas/gylee/0.GWAS/Code/SAIGE_code_folder/SAIGE.sh ${Sample} ${Thread} ${A} > /dev/null 2>&1 &
done
