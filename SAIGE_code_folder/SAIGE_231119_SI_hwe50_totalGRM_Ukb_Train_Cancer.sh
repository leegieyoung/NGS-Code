...
singularity exec --bind /ichrogene/:/ichrogene/ /ichrogene/project/temp/gylee/Singularity/GWAS.sif Rscript /ichrogene/project/temp/gylee/0.GWAS/Code/R/covariate_SI_forSAIGE.R
...
singularity exec --bind /ichrogene/:/ichrogene/ /ichrogene/project/temp/gylee/Singularity/SAIGE/SAIGE_docker_R36.sif bash /ichrogene/project/temp/gylee/0.GWAS/Code/SAIGE_code_folder/SAIGE_totalGRM_CreateGRM_5000_231121.sh ${Sample} ${Thread}
...
for A in $(seq 1 22)
do
nohup singularity exec --bind /ichrogene/:/ichrogene/ /ichrogene/project/temp/gylee/Singularity/SAIGE/SAIGE_docker_R36.sif bash /ichrogene/project/temp/gylee/0.GWAS/Code/SAIGE_code_folder/SAIGE_totalGRM_5000_231121.sh ${Sample} ${Thread} ${A} > ${Log}.chr${A}.doSAIGE.txt 2>&1 &
done
wait
singularity exec --bind /ichrogene/:/ichrogene/ /ichrogene/project/temp/gylee/Singularity/SAIGE/SAIGE_docker_R36.sif bash /ichrogene/project/temp/gylee/0.GWAS/Code/SAIGE_code_folder/Step3.merge.sh ${Sample} ${Thread}
