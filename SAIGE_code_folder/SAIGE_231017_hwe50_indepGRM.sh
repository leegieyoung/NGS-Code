...
#Module
make_pgen() {
 local file="/mnt/nas/gylee/0.GWAS/05.Imputation/2.minimac4/minimac4.1.0/${Sample}/${Sample}_pheno.IID"
 if [ -e "$file" ]; then
...
${p2_Dir}/plink2 --pfile /mnt/nas/gylee/0.GWAS/05.Imputation/2.minimac4/minimac4.1.0/Ukb_91584_R2_0.3/imputation \
 --keep /mnt/nas/gylee/0.GWAS/05.Imputation/2.minimac4/minimac4.1.0/${Sample}/${Sample}_pheno.IID \
 --make-pgen \
 --memory ${MEM} \
