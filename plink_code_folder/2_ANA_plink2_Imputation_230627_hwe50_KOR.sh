...
##cp /mnt/nas/gylee/0.GWAS/1.Input/KNIH_72295ea_info0.8/1.QC/KNIH_72295ea_info0.8_pheno.txt ${Output_dir}/${Sample}_pheno.txt
#
...
#
#singularity exec --bind /mnt/:/mnt/ /mnt/nas/gylee/Singurality/GWAS.sif Rscript /mnt/nas/gylee/0.GWAS/Code/R/covariate_KOR.R
...
#bash /mnt/nas/gylee/0.GWAS/Code/plink_code_folder/3_prune_KOR.sh ${Sample} ${Thread} ${MEM}
