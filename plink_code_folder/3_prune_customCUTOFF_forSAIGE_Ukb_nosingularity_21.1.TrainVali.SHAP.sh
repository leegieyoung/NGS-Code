...
singularity exec --bind /ichrogene/:/ichrogene/ /ichrogene/project/temp/gylee/Singularity/PRS.sif bash /ichrogene/project/temp/gylee/0.GWAS/4.PRS/Cancer/calculate_PRS.240122_21.1.MH_force_samples.TrainVali.sh ${Sample} ${TRAIT} ${CUTOFF} ${TrainVali}
