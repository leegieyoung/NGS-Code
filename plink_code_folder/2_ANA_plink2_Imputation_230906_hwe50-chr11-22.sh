...
#cp /mnt/nas/gylee/0.GWAS/05.Imputation/2.minimac4/minimac4.1.0/${Sample}/${Sample}_pheno.list ${Output_dir}/${Sample}_pheno.list
#
#${p2_Dir}/plink2 --pfile /mnt/nas/gylee/0.GWAS/05.Imputation/2.minimac4/minimac4.1.0/Ukb_91584_R2_0.3/imputation \
# --keep ${Output_dir}/${Sample}_pheno.list \
# --memory ${MEM} \
# --make-pgen \
...
for A in $(seq 11 22)
do
${p2_Dir}/plink2 --pfile ${Output_dir}/chr${A}.imputation_g_m_maf_hwe_addremain \
...
#bash /mnt/nas/gylee/0.GWAS/Code/plink_code_folder/3_prune.sh ${Sample} ${Thread} ${MEM}
done
