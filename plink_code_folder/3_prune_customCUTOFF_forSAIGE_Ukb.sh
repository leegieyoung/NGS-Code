...
singularity exec --bind /ichrogene/:/ichrogene/ /ichrogene/project/temp/gylee/Singularity/GWAS.sif Rscript /ichrogene/project/temp/gylee/0.GWAS/Code/R/make_marker_forSAIGE.R
...
bash /ichrogene/project/temp/gylee/0.GWAS/4.PRS/Cancer/calculate_PRS.231121_MH_force_samples.sh ${Sample} ${TRAIT} ${CUTOFF}
