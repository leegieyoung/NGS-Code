...
mkdir -p ${Dir}/2.plink_result/Imputed_${Sample}/temp
mkdir -p ${Dir}/2.plink_result/Imputed_${Sample}/result
ana_dir="${Dir}/2.plink_result/Imputed_${Sample}"
...
## Add phenotype
export ANA_DIR="${Dir}/2.plink_result/Imputed_${Sample}/"
