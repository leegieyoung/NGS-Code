...
head -n 1 ${Output_dir}/${Sample}.PHENO1.glm.logistic.hybrid > ${Output_dir}/header
cat ${Output_dir}/header ${Output_dir}/prune/raw_min0.02.prune.glm > ${Output_dir}/prune/min0.02.prune.glm
...
# --pheno ${Output_dir}/${Sample}_pheno.txt \
# --memory ${MEM} \
# --out ${Output_dir}/prune/1e-4.min0.02
#
#rm -rf ${Output_dir}/prune/raw_min0.02.prune.1e-4.glm
#touch ${Output_dir}/prune/raw_min0.02.prune.1e-4.glm
#
#for A in $(cat ${Output_dir}/prune/1e-4.min0.02.prune.in)
#do
#grep -w "${A}" ${Output_dir}/${Sample}.PHENO1.glm.logistic.hybrid.1e-4 >> ${Output_dir}/prune/raw_min0.02.prune.1e-4.glm
#done
#head -n 1 ${Output_dir}/${Sample}.PHENO1.glm.logistic.hybrid > ${Output_dir}/header
#cat ${Output_dir}/header ${Output_dir}/prune/raw_min0.02.prune.1e-4.glm > ${Output_dir}/prune/min0.02.prune.1e-4.glm
