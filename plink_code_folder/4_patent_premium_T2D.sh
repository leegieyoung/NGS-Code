...
#echo "----------------------------"
#echo ""
#cat ${Output_dir}/prune/premium_173.T2D.txt ${Dir}/2.plink_result/Imputed_Ukb_obesity_BMI_WC_premium/prune/premiumT2D.prune.in | sort | uniq > ${Output_dir}/prune/Obesity.premiumT2D_173.T2D.txt
#rm -rf ${Output_dir}/prune/raw.Obesity.premiumT2D_173.T2D.glm
#touch ${Output_dir}/prune/raw.Obesity.premiumT2D_173.T2D.glm
#
#for A in $(cat ${Output_dir}/prune/Obesity.premiumT2D_173.T2D.txt)
#do
#grep -w "${A}" ${Output_dir}/${Sample}.PHENO1.glm.logistic.hybrid >> ${Output_dir}/prune/raw.Obesity.premiumT2D_173.T2D.glm
#done
#
#head -n 1 ${Output_dir}/${Sample}.PHENO1.glm.logistic.hybrid > ${Output_dir}/header
#cat ${Output_dir}/header ${Output_dir}/prune/raw.Obesity.premiumT2D_173.T2D.glm > ${Output_dir}/prune/Obesity.premiumT2D_173.T2D.glm
#rm -rf ${Output_dir}/prune/raw.Obesity.premiumT2D_173.T2D.glm
#
#export CUTOFF="premiumT2D_173.T2D"
#singularity exec --bind /mnt/:/mnt/ /mnt/nas/gylee/Singurality/GWAS.sif Rscript /mnt/nas/gylee/0.GWAS/Code/R/make_marker_Obe_T2D.R
#
#nohup bash ${PRS_dir}/calculate_PRS.premiumT2D_173.T2D.sh ${Sample} type2diabet obesity &
#
#echo ""
#echo "----------------------------"
#echo " Finish     premiumT2D"
#echo "----------------------------"
#echo ""
#
##premiumT2D Marker
...
rm -rf ${Output_dir}/prune/raw.Obesity.premiumT2D.glm
touch ${Output_dir}/prune/raw.Obesity.premiumT2D.glm

for A in $(cat ${Output_dir}/rsID2ChrPosiEA_type2diabet_marker.list)
do
grep -w "${A}" ${Output_dir}/${Sample}.PHENO1.glm.logistic.hybrid >> ${Output_dir}/prune/raw.Obesity.premiumT2D.glm
done

head -n 1 ${Output_dir}/${Sample}.PHENO1.glm.logistic.hybrid > ${Output_dir}/header
cat ${Output_dir}/header ${Output_dir}/prune/raw.Obesity.premiumT2D.glm > ${Output_dir}/prune/Obesity.premiumT2D.glm
rm -rf ${Output_dir}/prune/raw.Obesity.premiumT2D.glm

export CUTOFF="premiumT2D"
singularity exec --bind /mnt/:/mnt/ /mnt/nas/gylee/Singurality/GWAS.sif Rscript /mnt/nas/gylee/0.GWAS/Code/R/make_marker_Obe_T2D.R

nohup bash ${PRS_dir}/calculate_PRS.premiumT2D.sh ${Sample} type2diabet obesity &
...
#echo "----------------------------"
#echo ""
#cat ${Output_dir}/prune/premium_174.T2D.txt ${Dir}/2.plink_result/Imputed_Ukb_obesity_BMI_WC_premium/prune/premiumT2D.prune.in | sort | uniq > ${Output_dir}/prune/Obesity.premiumT2D_173.T2D.txt
#rm -rf ${Output_dir}/prune/raw.Obesity.2premiumT2D_173.T2D.glm
#touch ${Output_dir}/prune/raw.Obesity.premiumT2D_173.T2D.glm
#
##for A in $(cat ${Output_dir}/prune/Obesity.premiumT2D_173.T2D.txt)
##do
...
#echo "----------------------------"
#echo ""
#cat ${Output_dir}/prune/premium_173.T2D.txt ${Dir}/2.plink_result/Imputed_Ukb_obesity_BMI_WC_premium/prune/premiumT2D.prune.in | sort | uniq > ${Output_dir}/prune/Obesity.premiumT2D.txt
#rm -rf ${Output_dir}/prune/raw.Obesity.premiumT2D.glm
#touch ${Output_dir}/prune/raw.Obesity.premiumT2D.glm
#
##for A in $(cat ${Output_dir}/prune/Obesity.premiumT2D.txt)
##do
##grep -w "${A}" ${Output_dir}/${Sample}.PHENO1.glm.logistic.hybrid >> ${Output_dir}/prune/raw.Obesity.premiumT2D.glm
##done
#
