...
Sample_folder="/mnt/data/gylee/0.GWAS/2.beagle_result/1.${input}"
Reference_folder="/mnt/data/gylee/0.GWAS/REFERENCE/1000_Genomes_phase3_v5a/b37.vcf"
Reference_bref3="/mnt/data/gylee/0.GWAS/REFERENCE/1000_Genomes_phase3_v5a/b37.bref3"
Result_folder="/mnt/data/gylee/0.GWAS/2.beagle_result"


mkdir ${Result_folder}/2.${input}_conform-gt_${input}
/usr/lib/jdk-16.0.2/bin/java -Xmx64g -jar ${Beagle_Code_folder}/conform-gt.24May16.cee.jar \
 ...
 chrom=${chr} \
 out=${Result_folder}/2.${input}_conform-gt_${input}/raw_CHR${chr}_${input}_noIndel_rmDupID_beagle \
 match=POS

mkdir ${Result_folder}/3.${input}_imputed_${input}
/usr/lib/jdk-16.0.2/bin/java -Xmx64g -jar ${Beagle_Code_folder}/beagle.18May20.d20.jar \
 ...
 chrom=${chr} \
 out=${Result_folder}/3.${input}_imputed_${input}/CHR${chr}_${input}_noIndel_rmDupID_beagle \
