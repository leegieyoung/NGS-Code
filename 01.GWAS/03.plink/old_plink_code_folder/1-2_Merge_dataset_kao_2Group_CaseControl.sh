...
cat ${Input2_result_folder}/MaMi/QC_Imputed_${Input2}.mergelist > ${result_folder}/QC/mergelist.txt
...
plink --bfile ${Input1_result_folder}/MaMi/QC_Imputed_${Input1} \
 ...
 --keep-allele-order \
 --threads 64 \
 --out ${result_folder}/MaMi/NoQC_Imputed_${OUTPUT}
mv ${result_folder}/MaMi/NoQC_Imputed_${OUTPUT}.log ${result_folder}/MaMi/NoQC_Imputed_${OUTPUT}_Nomissnp.log
...
cat ${result_folder}/MaMi/QC_rmmissnp_Imputed_${Input2}.mergelist > ${result_folder}/QC/mergelist_rmmissnp.txt
...
plink --bfile ${result_folder}/MaMi/QC_rmmissnp_Imputed_${Input1} \
 ...
 --keep-allele-order \
 --out ${result_folder}/MaMi/NoQC_Imputed_${OUTPUT}
mv ${result_folder}/MaMi/NoQC_Imputed_${OUTPUT}.log ${result_folder}/MaMi/NoQC_Imputed_${OUTPUT}_missnp.log

#=====================================merge End================================================

#=======================================rm NA =================================================
plink --bfile ${result_folder}/MaMi/NoQC_Imputed_${OUTPUT} \
 --freq case-control \
 --keep-allele-order \
 --allow-no-sex \
 --threads 64 \
