...
#snpsift dbsnp154
java -Xmx64g -jar /scratch/x1997a11/SnpEff/snpEff/SnpSift.jar annotate /scratch/x1997a11/REFERENCE/Anno/dbsnp154/dbsnp154.vcf.gz ${analysis_folder}/merge/logistic/anno/rmsnp.vcf > ${analysis_folder}/merge/logistic/anno/${Sample}_NoNA.vcf
...
#summary_file
#rsID
grep -v '^#' ${analysis_folder}/merge/logistic/anno/${Sample}_NoNA.vcf > ${analysis_folder}/merge/logistic/anno/nohead_${Sample}_NoNA.vcf
awk '{print $3}' ${analysis_folder}/merge/logistic/anno/nohead_${Sample}_NoNA.vcf > ${analysis_folder}/merge/logistic/anno/${Sample}_NoNA.rsID
awk '{print $1, $3}' ${analysis_folder}/merge/logistic/anno/nohead_${Sample}_NoNA.vcf >  ${analysis_folder}/merge/logistic/anno/${Sample}_NoNA.chr_rsID
sed -i '1i\ rsID' ${analysis_folder}/merge/logistic/anno/${Sample}_NoNA.rsID

#pval
awk '{print $12}' ${analysis_folder}/merge/logistic/raw_${Sample}_NoNA_assoc.assoc.logistic > ${analysis_folder}/merge/logistic/anno/${Sample}_NoNA_assoc.pval

paste ${analysis_folder}/merge/logistic/anno/${Sample}_NoNA.rsID ${analysis_folder}/merge/logistic/anno/${Sample}_NoNA_freq.frq.cc ${analysis_folder}/merge/logistic/anno/${Sample}_NoNA_assoc.pval > ${analysis_folder}/merge/logistic/anno/summary_result.csv
...
awk '{print $7 ,$12}' ${analysis_folder}/merge/logistic/anno/${Sample}_NoNA_assoc.assoc.logistic > ${analysis_folder}/merge/logistic/predixcan/${Sample}_NoNA.beta_pval

awk '{print $1}'  ${analysis_folder}/merge/logistic/anno/${Sample}_NoNA_freq.frq.cc > ${analysis_folder}/merge/logistic/predixcan/chr.txt
awk '{print $3, $4}'  ${analysis_folder}/merge/logistic/anno/${Sample}_NoNA_freq.frq.cc > ${analysis_folder}/merge/logistic/predixcan/A1_A2.txt

paste ${analysis_folder}/merge/logistic/predixcan/chr.txt ${analysis_folder}/merge/logistic/anno/${Sample}_NoNA.rsID ${analysis_folder}/merge/logistic/predixcan/A1_A2.txt ${analysis_folder}/merge/logistic/predixcan/${Sample}_NoNA.beta_pval > ${analysis_folder}/merge/logistic/predixcan/${Sample}.predixcan
