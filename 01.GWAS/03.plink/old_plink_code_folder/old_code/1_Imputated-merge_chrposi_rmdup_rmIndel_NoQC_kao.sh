...
for Chrom in {1..22}
do
plink --vcf ${Sample_folder}/CHR${Chrom}_QC_${Sample}_noIndel_rmDupID_beagle.vcf.gz  --make-bed --keep-allele-order --out ${result_folder}/raw_merge/NoQC_CHR${Chrom}_${Sample}
done
