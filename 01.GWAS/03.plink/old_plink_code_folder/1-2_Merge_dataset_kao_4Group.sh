...
Input4_result_folder="${GWAS_path}/QC_Imputed_${Input4}"
...
echo ${Input4_result_folder}/MaMi/QC_Imputed_${Input4}.bed ${Input4_result_folder}/MaMi/QC_Imputed_${Input4}.bim ${Input4_result_folder}/MaMi/QC_Imputed_${Input4}.fam > ${Input4_result_folder}/MaMi/QC_Imputed_${Input4}.mergelist

cat ${Input2_result_folder}/MaMi/QC_Imputed_${Input2}.mergelist ${Input3_result_folder}/MaMi/QC_Imputed_${Input3}.mergelist ${Input4_result_folder}/MaMi/QC_Imputed_${Input4}.mergelist > ${result_folder}/QC/mergelist.txt
...
plink --bfile ${Input4_result_folder}/MaMi/QC_Imputed_${Input4} \
 --exclude ${result_folder}/MaMi/QC_Imputed_${OUTPUT}-merge.missnp \
 --make-bed \
 --keep-allele-order \
 --out ${result_folder}/MaMi/QC_rmmissnp_Imputed_${Input4}
...
echo ${result_folder}/MaMi/QC_rmmissnp_Imputed_${Input4}.bed ${result_folder}/MaMi/QC_rmmissnp_Imputed_${Input4}.bim ${result_folder}/MaMi/QC_rmmissnp_Imputed_${Input4}.fam > ${result_folder}/MaMi/QC_rmmissnp_Imputed_${Input4}.mergelist

cat ${result_folder}/MaMi/QC_rmmissnp_Imputed_${Input2}.mergelist ${result_folder}/MaMi/QC_rmmissnp_Imputed_${Input3}.mergelist ${result_folder}/MaMi/QC_rmmissnp_Imputed_${Input4}.mergelist > ${result_folder}/QC/mergelist_rmmissnp.txt
