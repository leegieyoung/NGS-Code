...
##What is Code?##
echo "${code_path}/2_merge_CaseControl_analysis_major_missnp_maf001_kao.sh" > ${analysis_folder}/merge/Used_2_merge_CaseControl_analysis_major_missnp_maf001_kao.sh
...
awk '{print $1, $5}' ${analysis_folder}/merge/raw_${Case}_${Control}_NoNA > ${analysis_folder}/merge/logistic.covar_sex.txt
