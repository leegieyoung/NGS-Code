...
for Chrom in {1..22}
do
plink -vcf /scratch/hpc46a05/GWAS/1000G/b37.vcf/chr${Chrom}.1kg.phase3.v5a.vcf.gz \
...
plink --bfile ${result_folder}/QC/raw_NoQC_same_posi_Imputed_${Sample} \
 ...
 --keep-allele-order \
 --make-bed \
 --keep /scratch/hpc46a05/GWAS/result/QC_Imputed_1000G-EAS_chr-posi/MaMi/keep.list \
