...
for Chrom in {1..22}
do
plink --vcf ${Sample_folder}/CHR${Chrom}_${Sample}_noIndel_rmDupID_phased_beagle.vcf.gz --double-id --make-bed --keep-allele-order --out ${result_folder}/raw_merge/NoQC_CHR${Chrom}_${Sample}
done
