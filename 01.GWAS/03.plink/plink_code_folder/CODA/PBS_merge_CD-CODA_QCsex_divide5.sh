...
sh ${Code_path}/1-2_Merge_dataset_kao_2Group.sh snpQC_CD-CODA_divide5 snpQC-CD CODA_QCsex_divide5
sh ${Code_path}/2_Single_CaseControl_analysis_major_kao_QC.sh Imputed_snpQC_CD-CODA_divide5
