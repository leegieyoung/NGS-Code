...
plink --bfile ${result_folder}/QC/raw_Case --mind 0.02 --make-bed --out ${result_folder}/QC/raw_Case_m
plink --bfile ${result_folder}/QC/raw_Case_m --geno 0.02 --make-bed --out ${result_folder}/QC/raw_Case_m_g
...
plink --bfile ${result_folder}/QC/raw_Case_m_g \
 --maf 0.05 \
 --make-bed \
 --out ${result_folder}/QC/raw_Case_m_g_maf

plink --bfile ${result_folder}/QC/raw_Case_m_g_maf \
 --hwe 1e-6 \
 --make-bed \
 --out ${result_folder}/QC/raw_Case_m_g_maf_hwe
...
cp -v ${result_folder}/QC/raw_Case_m_g_maf_hwe.bim ${result_folder}/MaMi/QC_${Sample}.bim
cp -v ${result_folder}/QC/raw_Case_m_g_maf_hwe.bed ${result_folder}/MaMi/QC_${Sample}.bed
#cp -v ${result_folder}/QC/raw_Case_m_g_maf_hwe.fam ${result_folder}/MaMi/QC_${Sample}.fam
awk '{sub(/-9/,"2",$6);print > "'${result_folder}'/MaMi/pheCase_QC_'${Sample}.fam'"}' ${result_folder}/QC/raw_Case_m_g_maf_hwe.fam
