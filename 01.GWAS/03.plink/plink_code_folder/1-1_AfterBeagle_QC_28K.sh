...
awk '$2 != "." && $5 != "." && $6 != "." {print $2}' /scratch/hpc46a05/GWAS/KCHIP/${Chrom}.refCheckedRmDup.bim > ${result_folder}/raw_merge/NoQC_rmIDdot_CHR${Chrom}_${Sample}.txt
plink --bfile /scratch/hpc46a05/GWAS/KCHIP/${Chrom}.refCheckedRmDup \
