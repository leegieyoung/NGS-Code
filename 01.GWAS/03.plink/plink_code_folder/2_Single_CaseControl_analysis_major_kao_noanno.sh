...
paste -d '\t' ${analysis_folder}/merge/PCA/raw_${Sample}_PCA.csv ${analysis_folder}/merge/PCA/${Sample}_NoNA_PCA.eigenval > ${analysis_folder}/merge/PCA/raw_${Sample}_PCA_eigenval.csv
