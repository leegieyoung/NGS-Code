...
Reference_folder="/scratch/hpc46a05/REFERENCE/KCHIPref"
Reference_bref3="/scratch/hpc46a05/REFERENCE/KCHIPref"
...
java -Xmx64g -jar ${Beagle_Code_folder}/conform-gt.24May16.cee.jar \
 ref=${Reference_folder}/${Chrom}.refCheckedRmDup.vcf.gz \
...
java -Xmx64g -jar ${Beagle_Code_folder}/beagle.18May20.d20.jar \
 ref=${Reference_bref3}/${Chrom}.refCheckedRmDup.bref3 \
